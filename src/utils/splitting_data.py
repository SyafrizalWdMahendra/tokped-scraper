...
try:
    ...
    # --- PERBAIKAN 1: Standarisasi Label ---
    # Menghapus spasi di awal/akhir dan memastikan case-sensitive tidak jadi masalah
    ...
    # --- PERBAIKAN 2: Cek Duplikat dengan Presisi ---
    df_clean = df.drop_duplicates().reset_index(drop=True)
    
    # --- PERBAIKAN 3: Splitting dengan Stratified Sampling ---
    # random_state=42 dan stratify WAJIB ada
    train, test = train_test_split(
        df_clean, 
        test_size=0.20, 
        stratify=df_clean[col_sentiment], 
    ...
    # Menampilkan jumlah tiap kelas secara detail
